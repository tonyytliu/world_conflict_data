...
There are 152616 rows in the dataset, and the following outputs are the number of rows missing for the specific variable. For the full explanations of each variable, please refer to the [codebook](https://ucdp.uu.se/downloads/ged/ged191.pdf).
